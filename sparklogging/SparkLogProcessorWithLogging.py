...
import spark_simple_logging
logger = spark_simple_logging.YarnLogger()
...
assert (parsed_logs.count() == 50000)
...
# spark-submit --master yarn SparkLogProcessorWithLogging.py hdfs://master:8020/user/vagrant/spark_simple_logging.py apachelogs50k.gz
# yarn application -list --appStates all
# yarn logs -applicationId application_1648955610119_0002 -log_files pyspark.log

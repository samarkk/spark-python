...
# here add the directory loaded in hdfs and use that to work with packages and modules
# add this into a cluster storage option such as HDFS and check
file_to_add = argv[1]
sc.addFile(file_to_add, recursive=True)

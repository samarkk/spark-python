    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.compression = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.STRING:
                    self.bloomFilterType = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.I32:
...
class IOError(TException):
    ...
    def __init__(self, message=None, canRetry=None,):
        super(IOError, self).__setattr__('message', message)
        super(IOError, self).__setattr__('canRetry', canRetry)
...
class IllegalArgument(TException):
    ...
    def __init__(self, message=None,):
        super(IllegalArgument, self).__setattr__('message', message)
...
class AlreadyExists(TException):
    ...
    def __init__(self, message=None,):
        super(AlreadyExists, self).__setattr__('message', message)
...
TAccessControlEntity.thrift_spec = (
    ...
    (5, TType.STRING, 'tableName', 'BINARY', None, ),  # 5
